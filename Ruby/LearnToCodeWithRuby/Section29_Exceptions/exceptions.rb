...
def sum(a, b)
  a + b
rescue StandardError # the rescue case just by itself will catch any exception
...
rescue StandardError => e # e is the exception object
...
begin
  sum6('3', 5)
rescue TypeError # you can't acccess a and b here, so you can't correct them!
...
class Oven
  ...
  # in addition to giving raise a message, you can gave it a class
  def bake(item)
