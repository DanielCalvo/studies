...
- If asked to work with Kubernetes, read [.agents/kubernetes.md](studies/.agents/kubernetes.md)
- If asked to work with Terraform, read [.agents/terraform.md](studies/.agents/terraform.md)
- If asked to work with Go, read [.agents/go.md](studies/.agents/go.md)

All codex skills are located under [.codex/skills](studies/.codex/skills)
